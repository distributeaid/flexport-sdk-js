...
export type Cargo = {
     ...
     * JSON-schema: array
     */
    readonly lithium_batteries_packing_types?: ("packed_loose" | "packed_with_equipment" | "contained_in_equipment" | "contained_in_battery_powered_vehicles")[];
};
export type LiftedCargo = Omit<Cargo, > & {};
/**
