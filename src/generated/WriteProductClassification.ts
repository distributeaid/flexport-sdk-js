...
export type LiftedWriteProductClassification = Omit<WriteProductClassification, > & {};
/**
 * Lifts an object return from a Flexport API responses into the SDK domain by augmenting them with higher level properties.
 */
export const liftWriteProductClassification = (original: WriteProductClassification) => {
    return original;
};