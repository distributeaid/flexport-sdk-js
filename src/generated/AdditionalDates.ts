...
export type LiftedAdditionalDates = Omit<AdditionalDates, "delivery_appointment_requested_at_date" | "delivery_appointment_requested_date" | "delivery_appointment_scheduled_at_date" | "delivery_appointment_scheduled_date" | "loaded_on_truck_date" | "delivery_completed"> & {
    /**
     * Date at which the appointment was first requested
     */
