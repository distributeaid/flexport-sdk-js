...
export type LiftedCreateBookingHsCode = TypedApiObject & CreateBookingHsCode
/**
 * Lifts an object return from a Flexport API responses into the SDK domain by augmenting them with higher level properties.
 */
export const liftCreateBookingHsCode = (
	original: CreateBookingHsCode,
): LiftedCreateBookingHsCode => {
	return original
}
