...
export type LiftedBookingLineItemCollectionRef = Omit<BookingLineItemCollectionRef, > & {};
/**
 * Lifts an object return from a Flexport API responses into the SDK domain by augmenting them with higher level properties.
 */
export const liftBookingLineItemCollectionRef = (original: BookingLineItemCollectionRef) => {
    return original;
};