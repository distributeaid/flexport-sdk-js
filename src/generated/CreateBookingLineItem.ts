...
export type LiftedCreateBookingLineItem = CreateBookingLineItem
/**
 * Lifts an object return from a Flexport API responses into the SDK domain by augmenting them with higher level properties.
 */
export const liftCreateBookingLineItem = (
	original: CreateBookingLineItem,
): LiftedCreateBookingLineItem => {
	return original
}
