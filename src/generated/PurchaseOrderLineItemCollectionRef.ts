...
export type LiftedPurchaseOrderLineItemCollectionRef = Omit<PurchaseOrderLineItemCollectionRef, > & {};
/**
 * Lifts an object return from a Flexport API responses into the SDK domain by augmenting them with higher level properties.
 */
export const liftPurchaseOrderLineItemCollectionRef = (original: PurchaseOrderLineItemCollectionRef) => {
    return original;
};